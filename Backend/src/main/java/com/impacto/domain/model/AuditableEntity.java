...
@MappedSuperclass @EntityListeners(AuditingEntityListener.class) public abstract class AuditableEntity {
    ...
    @CreatedBy @Column(updatable=false) protected UUID createdBy;
    @LastModifiedBy
