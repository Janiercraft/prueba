...
public class DonationService {
    ...
    public DonationService(DonationRepository r, DonorRepository d, CampaignRepository c, ResourceRepository re,
                           ResourceCodeService co) {
        repo=r;
        donors=d;
        campaigns=c;
        resources=re;
    ...
    public com.impacto.dto.DonorImpactResponse impact(UUID donorId) {
        UUID id=donorId;
        donors.findById(id).orElseThrow(()->new NotFoundException("Donante no encontrado"));
        ...
        return new com.impacto.dto.DonorImpactResponse(total,repo.sumAmountByDonorId(id,DonationType.MONEY,DonationStatus.RECEIVED),material);
    }
